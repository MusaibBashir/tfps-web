...
import { Users, Package, Camera, UserPlus } from "lucide-react"
...
const AdminPage = () => {
  ...
  useEffect(() => {
    ...
    if (tab && ["users", "equipment"].includes(tab)) {
      setActiveTab(tab)
    }
  }, [location])
      ...
      {activeTab === "users" && (
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">Create a new account for a soc member</p>
          </div>
      ...
      {activeTab === "equipment" && (
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
            ...
            <p className="mt-1 text-sm text-gray-500">Register new equipment in the system</p>
          </div>
          <div className="px-4 py-5 sm:p-6">
            <AddEquipmentForm />
          </div>
