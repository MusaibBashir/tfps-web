...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 text-sm">Technology Film and Photography Society</p>
              </div>
            </div>
            <Link
              to="/login"
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-gray-900 via-gray-800 to-primary-900 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#about"
              className="border-2 border-primary-500 text-primary-400 px-8 py-3 rounded-lg font-semibold hover:bg-primary-600 hover:text-white transition-colors"
            >
              Learn More
            </a>
          </div>
            ...
            {instagramPosts.map((post) => (
              <div key={post.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  ...
                  <div className="mt-3 text-xs text-gray-500">{post.likes}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-gray-300">Equipment Items</div>
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <a href="#inquiry" className="hover:text-primary-400 transition-colors">
                    Contact
                  </a>
                </li>
                <li>
            ...
            <div>
              <h4 className="font-semibold mb-4 text-primary-400">Connect With Us</h4>
              ...
              <div className="mt-4 flex space-x-4">
                ...
                <a href="#" className="text-gray-400 hover:text-primary-400 transition-colors">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.954 4.569c-.885.389-1.83.654-2.825.775 1.014-.611 1.794-1.574 2.163-2.723-.951.555-2.005.959-3.127 1.184-.896-.959-2.173-1.559-3.591-1.559-2.717 0-4.92 2.203-4.92 4.917 0 .39.045.765.127 1.124C7.691 8.341 4.066 6.215 1.613 3.124c-.402.69-.635 1.492-.635 2.342 0 1.616.819 3.041 2.058 3.876-.802-.025-1.561-.245-2.229-.616v.061c0 2.257 1.605 4.14 3.737 4.568-.392.106-.803.162-1.227.162-.299 0-.593-.029-.877-.082.593 1.85 2.313 3.198 4.352 3.234-1.595 1.25-3.604 1.995-5.786 1.995-.376 0-.747-.022-1.112-.065 2.062 1.323 4.511 2.093 7.14 2.093 8.569 0 13.255-7.098 13.255-13.254 0-.201-.005-.402-.014-.602.919-.658 1.729-1.477 2.37-2.415z" />
                  </svg>
                </a>
              </div>
            </div>
